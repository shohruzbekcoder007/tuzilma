            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 px-4 md:px-6">
              <div className="flex flex-col items-center md:items-start gap-0 text-center md:text-left">
                ...
                <p className="text-[12px] text-muted-foreground flex items-center gap-1 my-[6px]">
                  <Shield className="h-4 w-4" />  Бошқарув ходимлар - <span className="font-bold text-blue-500">{statistic?.employees_management_count}</span> / <span className="font-bold text-green-500">{statistic?.work_place_management_count}</span>
                </p>
                <p className="text-[12px] text-muted-foreground flex items-center gap-1">
                  <Settings className="h-4 w-4" />  Техник ходимлар - <span className="font-bold text-blue-500">{statistic?.employees_technical_count}</span> / <span className="font-bold text-green-500">{statistic?.work_place_technical_count}</span>
                </p>
              </div>
              <div className="flex flex-col items-center md:items-start gap-0 text-center md:text-left">
                ...
                <Dialog open={isOpen} onOpenChange={setIsOpen}>
                  ...
                  >
                    <Users className="h-4 w-4" />  Вакантлар - <span className="font-bold text-blue-500">{statistic?.open_work_count}</span>
                  </Button>
